(function($) {
  ...
  $(function() {
    ...
    if ($("#sleep-history").length) {
      var areaData = {
        labels: ["Slept", "Didn't Sleep"],
        datasets: [{
            data: [91.25, 8.75],
            backgroundColor: [
              "#FF0004", "#111111"
      ...
      var transactionhistoryChartCanvas = $("#sleep-history").get(0).getContext("2d");
    ...
    if ($("#readiness-history").length) {
      ...
      var transactionhistoryChartCanvas = $("#readiness-history").get(0).getContext("2d");
      var transactionhistoryChart = new Chart(transactionhistoryChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
    ...
    if ($("#nutrition-history").length) {
      ...
      var transactionhistoryChartCanvas = $("#nutrition-history").get(0).getContext("2d");
      var transactionhistoryChart = new Chart(transactionhistoryChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
